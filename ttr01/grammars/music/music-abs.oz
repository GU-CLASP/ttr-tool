...
export
   Dudamel Beethoven IndefArt Composer Conductor Be Ok Aha S_NP_VP NP_Det_N %N_Adj_N
   VP_Cop_NP D_D_S D_S
define
   ...
   Dudamel = {Lex 'Dudamel' np}
   Beethoven = {Lex 'Beethoven' np}
   IndefArt = {Lex 'IndefArt' det}
   Composer = {Lex 'Composer' n}
   Conductor = {Lex 'Conductor' n}
   Be = {Lex 'Be' cop}
   Ok = {Lex 'Ok' s}
   Aha = {Lex 'Aha' s}
